...
export function SalaCreada() {
  return (
    <div className="w-full max-w-[60%]  bottom-0 fixed items-center">
      <Navbar />
      <form>
          <label htmlFor="chat" className="sr-only">Mensaje...</label>
          <div className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
              <label htmlFor="fileInput" className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
